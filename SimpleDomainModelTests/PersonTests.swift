...
class PersonTests: XCTestCase {
  ...
  func testPerson() {
    ...
    //Description Test
    XCTAssert(ted.description == ted.toString())
  }
  ...
  func testAgeRestrictions() {
    ...
    //Description Test
    XCTAssert(matt.description == matt.toString())
  ...
  func testAdultAgeRestrictions() {
    ...
    //Description Test
    XCTAssert(mike.description == mike.toString())
...
class FamilyTests : XCTestCase {
  ...
  func testFamily() {
    ...
    //Description Test
    XCTAssert(family.description == "spounse1:Ted spouse2:Charlotte")
  ...
  func testFamilyWithKids() {
    ...
    //Description Test
    XCTAssert(family.description == "spounse1:Ted spouse2:Charlotte child:Mike child:Matt")
